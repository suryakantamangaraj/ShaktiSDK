...
code reused by Kottee and Yasaswini for shakti porting
*/
...
#define MPU6050_REG_GYRO_X///OUT_H       (0x43)
...
#define WHO_AM_I_DATA         (0x68)
#define MPU6050_RESET         (0x80)
#define MPU6050_CLK_8MHz      (0x00) //set MPU6050 clock at 8MHZ
#define MPU6050_CLK_GYROX     (0x01)
#define MPU6050_CLK_GYROY     (0x02)
#define MPU6050_CLK_GYROZ     (0x03)
#define MPU6050_CLK_32_76KHz  (0x04)
#define MPU6050_CLK_19_2MHz   (0x05)
#define ACC_SENS_2g         (0x00)
#define ACC_SENS_4g         (0x08)
#define ACC_SENS_8g         (0x10)
#define ACC_SENS_16g        (0x18)
#define GYRO_SENS_250       (0x00)
#define GYRO_SENS_500       (0x08)
#define GYRO_SENS_1000       (0x10)
#define GYRO_SENS_2000       (0x18)
